...
public class QandAFind extends DialogFragment{
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		View dialogView = inflater.inflate(R.layout.q_and_a_find, null);

		builder.setTitle("Where to find").setView(dialogView)
		...
		EditText question = (EditText) dialog.findViewById(R.id.post_question_find);
		...
		Button submitQuestion = (Button) dialog.findViewById(R.id.submit_find_question);
		submitQuestion.setOnClickListener( new OnClickListener(){

			@Override
			public void onClick(View v) {
				EditText question = (EditText)((Dialog) dialog).findViewById(R.id.post_question_find);
				if (question.getText().toString().equals("")){
					Toast.makeText(((Dialog) dialog).getContext(), "Please enter a valid question", Toast.LENGTH_SHORT).show();
				} else {
					TextView userQuestion = (TextView)((Dialog) dialog).findViewById(R.id.user_find_question);
