...
public class ShowTotalWholeFoods extends DialogFragment{
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		builder.setView(dialogView).setTitle("Whole Foods").setPositiveButton("Find In Store", new DialogInterface.OnClickListener(){
		...
		store.setCompoundDrawablesWithIntrinsicBounds(R.drawable.whole_foods, 0, 0, 0);
