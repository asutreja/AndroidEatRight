...
public class QandARecipe extends DialogFragment{
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		View dialogView = inflater.inflate(R.layout.q_and_a_recipe, null);
		
		builder.setTitle("Recipes Board").setView(dialogView)
		...
		EditText question = (EditText) dialog.findViewById(R.id.post_question_recipe);
		...
		Button submitQuestion = (Button) dialog.findViewById(R.id.submit_recipe_question);
		submitQuestion.setOnClickListener( new OnClickListener(){

			@Override
			public void onClick(View v) {
				EditText question = (EditText)((Dialog) dialog).findViewById(R.id.post_question_recipe);
				if (question.getText().toString().equals("")){
					Toast.makeText(((Dialog) dialog).getContext(), "Please enter a valid question", Toast.LENGTH_SHORT).show();
				} else {
					TextView userQuestion = (TextView)((Dialog) dialog).findViewById(R.id.user_recipe_question);
